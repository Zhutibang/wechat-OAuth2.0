...
function getUserInfo($appid, $appsecret){
    ...
    $weixin_auth='https://open.weixin.qq.com/connect/oauth2/authorize?appid='.$appid.'&redirect_uri='.urlencode($redirect_url).'&response_type=code&scope=snsapi_base&state=ZHUTIBANG#wechat_redirect';
